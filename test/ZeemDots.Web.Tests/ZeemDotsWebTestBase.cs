...
{
    public abstract class ZeemDotsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ZeemDotsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ZeemDotsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ZeemDotsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ZeemDotsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ZeemDotsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ZeemDotsDbContext, Task<T>> func)
        {
            T result;
